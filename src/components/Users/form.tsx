    ...
    return (
        <ErrorBoundary hasData={props.status && props.type==="Edit" ? (data ? true : false) : true} isLoading={isLoading || isFetching} status={props.status && props.type==="Edit" ? status : "success"} error={error} hasPagination={false} refetch={refetch}>
            <form onSubmit={form.onSubmit(onSubmit)}>
                ...
                <Button type='submit' variant="filled" color='main' mt="lg" loading={props.type === "Create" ? addUser.isPending : updateUser.isPending} disabled={props.type === "Create" ? addUser.isPending : updateUser.isPending} data-disabled={props.type === "Create" ? addUser.isPending : updateUser.isPending}>
